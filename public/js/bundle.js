        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'sucess') {
              (0, _alerts.showAlert)('success', 'you have logged in sucessfully');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            console.log(res); // console.log(res.data.status)

            if (res.data.status === 'sucess') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), "updated successfully"));
            _context.next = 12;
            break;
